...
public class FrmModifyAssessment extends JDialog implements ActionListener {

	public BeanMenuAssessment assess = null;
	...
	public FrmModifyAssessment(JDialog f, String s, boolean b, BeanMenuAssessment assess) {
		super(f, s, b);
		this.assess = assess;
...
//		fc.setBounds(80, 190, 70, 50);
		...
		bg.add(s4);
		bg.add(s5);
		edtDescription.setText(this.assess.getMenuAssessmentContent());
		switch ((int) this.assess.getMenuScore()) {
		case 2:
			s1.setSelected(true);
			break;
		case 4:
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == this.btnCancel) {
			...
			try {
				KitchenAssistantUtil.assessmentManager.modify(assess, assessment, isCollected, menuScore);
				this.setVisible(false);
