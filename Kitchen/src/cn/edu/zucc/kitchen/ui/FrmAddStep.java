...
public class FrmAddStep extends JDialog implements ActionListener {
	...
	private JLabel labelStepOrder = new JLabel("步骤序号：");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == this.btnCancel) {
			...
			if("".equals((String) this.cmbReadertype.getSelectedItem())||((String) this.cmbReadertype.getSelectedItem())==null) {
				JOptionPane.showMessageDialog(null, "请选择步骤号", "错误", JOptionPane.ERROR_MESSAGE);
				return;
			}
			...
			if("".equals(filepath)||(filepath)==null) {
				JOptionPane.showMessageDialog(null, "您还没有上传步骤图片\n您之后可以在步骤修改中上传图片","提示",JOptionPane.INFORMATION_MESSAGE); 
			}
			try {
